...
"QPushButton:pressed{background-color:rgba(255,255,255,0.5);}")
        ...
        self.pushButton_2.setGeometry(QtCore.QRect(0, 30, 121, 30))
        self.pushButton_2.setObjectName("pushButton_2")
        self.label = QtWidgets.QLabel(self.widget_3)
        self.label.setGeometry(QtCore.QRect(0, 10, 101, 16))
        self.label.setObjectName("label")
        self.lineEdit = QtWidgets.QLineEdit(self.widget_3)
        self.lineEdit.setGeometry(QtCore.QRect(98, 7, 21, 20))
...
" border:2px solid rgb(100,50,30);background:rgba(255,255,255,0.7);border-radius:4px}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_2.setText(_translate("MainWindow", "自动刷本"))
